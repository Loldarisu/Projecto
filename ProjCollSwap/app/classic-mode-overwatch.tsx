    ...
    <View style={[styles.containerCenter, styles.backgroundPurple]}>      
      ...
      <View style={local.cardsRow}>
        ...
        <View style={local.cardItemGreen}>
          <Text style={local.cardLabel}>Female</Text>
        </View>
        <View style={local.cardItemGreen}>
          <Text style={local.cardLabel}>English</Text>
        </View>
        <View style={local.cardItemGreen}>
          <Text style={local.cardLabel}>Damage</Text>
        </View>
        <View style={local.cardItemGreen}>
          <Text style={local.cardLabel}>2021</Text>
        </View>
      </View>
    </View>
  );
