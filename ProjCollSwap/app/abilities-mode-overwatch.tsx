...
import abilityIcon from './custom/imgs/game/digimon/abilities/Agumon.png';
...
export default function AbilitiesModeScreen() {
  ...
  return (
    <View style={[styles.containerCenter, styles.backgroundPurple]}>
      ...
      {/* MODE ICON */}
      <Image source={abilityIcon} style={local.modeIcon} />

      {/* SINGLE RESULT CARD */}
      <View style={[local.cardResult, { backgroundColor: '#dc3545' }]}>
