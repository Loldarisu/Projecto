...
const data = [
    {
        ...
        route: '/classic-mode-overwatch',
    },
    {
        key: 'abilities',
        image: abilitiesImg,
        description: `A game where you have to guess the character based on one of their abilities.\nYou will only see the icon of an ability, without any name or description. Can you recognize the Hero  just from that?`,
        route: '/abilities-mode-overwatch',
    },
    {
        key: 'splashart',
        image: splashImg,
        description: `A game where you have to guess the character based on a part of their splash art.\nYou will only see a small cropped portion of the image. Can you recognize the Hero just from this detail?`,
        route: '/splashart-mode-overwatch',
    },
];
                ...
                {data.map((mode) => (
                    <View key={mode.key} style={local.row}>
                        <Pressable onPress={() => router.push(mode.route as const)} style={local.imageWrapper}>
                            <Image source={mode.image} style={local.image} contentFit="cover" />
                        </Pressable>
