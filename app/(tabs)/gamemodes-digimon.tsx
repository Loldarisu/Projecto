...
const data = [
    {
        ...
        route: '/classic-mode-digimon',
    },
    {
        key: 'abilities',
        image: abilitiesImg,
        description: `A game where you have to guess the character based on one of their abilities.\nYou will only see the icon of an ability, without any name or description. Can you recognize the digimon just from that?`,
        route: '/abilities-mode-digimon',
    },
    {
        key: 'splashart',
        image: splashImg,
        description: `A game where you have to guess the character based on a part of their splash art.\nYou will only see a small cropped portion of the image. Can you recognize the digimon just from this detail?`,
        route: '/splashart-mode-digimon',
    },
];
