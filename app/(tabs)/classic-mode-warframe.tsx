  ...
  return (
    <View style={[styles.containerCenter, styles.backgroundPurple]}>      
      ...
      <View style={local.labelsRow}>
        <Text style={local.labelHeader}>Warframe</Text>
        <Text style={local.labelHeader}>Sex</Text>
        <Text style={local.labelHeader}>Themes</Text>
        <Text style={local.labelHeader}>Progenitor</Text>
      ...
      <View style={local.cardsRow}>
        ...
        <View style={local.cardItemGreen}>
          <Text style={local.cardLabel}>Assassin</Text>
        </View>
        <View style={local.cardItemGreen}>
          <Text style={local.cardLabel}>Radiation</Text>
        </View>
        <View style={local.cardItemGreen}>
          <Text style={local.cardLabel}>2012</Text>
        </View>
      </View>
    </View>
  );
