    ...
    <View style={local.sectionContainer}>
      ...
      <View style={local.gridWrap}>
        {paddedData.map((item, index) => (
          ...
          >
            {item ? (
              <Image source={item} style={local.cardImage} contentFit="contain" />
            ) : (
...
export default function CollectionPage() {
  ...
  return (
    <ScrollView style={styles.backgroundPurple} contentContainerStyle={{ paddingBottom: 40 }}>
      {/* Header */}
      <View style={[local.header, {marginTop: 40, marginBottom: 20}]}>
      ...
      <Pressable style={[local.questsButton, {marginBottom: 40}]} onPress={() => router.push('./quests')}>
